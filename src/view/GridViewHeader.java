 ...
 *
 */
public class GridViewHeader extends android.widget.GridView implements OnScrollListener, android.widget.AdapterView.OnItemClickListener
{
	...
	public GridViewHeader(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(context);
	}

	public GridViewHeader(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	public GridViewHeader(Context context) {
		super(context);
		init(context);
	}
    ...
    public class mListAdapter extends BaseAdapter
    {
		...
		public int getCount() 
		{
			return originalAdapter.getCount() > 0 ? originalAdapter.getCount() + GridViewHeader.this.getNumColumnsCompat() : 0;
		}

		@Override
		public Object getItem(int position) 
		{
			return originalAdapter.getItem(position + GridViewHeader.this.getNumColumnsCompat());
		}

		@Override
		public long getItemId(int position) 
		{
			return originalAdapter.getItemId(position + GridViewHeader.this.getNumColumnsCompat());
		}
		...
		{
			if ( position < GridViewHeader.this.getNumColumnsCompat() )
			{
		...
		public View getView(int position, View convert, ViewGroup parent) 
		{
			if ( position < GridViewHeader.this.getNumColumnsCompat() )
			{
				...
				int realPosition = position - GridViewHeader.this.getNumColumnsCompat();
	...
	public void onItemClick(AdapterView<?> adapter, View view, int position, long id) 
	{
		...
		{
			clickListenerFromActivity.onItemClick(adapter, view, position - GridViewHeader.this.getNumColumnsCompat(), id);
		}
	}
}